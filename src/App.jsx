...
function App() {
  ...
  return (
    <div
      className={`min-h-screen w-full flex justify-center ${user && isAdmin ? 'items-start px-3 py-4 sm:px-6 sm:py-6 md:px-8' : 'items-center p-6'}`}
      style={{
    ...
    >
      <div className={`relative w-full ${user && isAdmin ? 'max-w-[1680px]' : 'max-w-5xl'}`}>
